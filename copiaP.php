    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        ...
        ?>
            ...
            <div class="container">
                <form  action="copiaP.php" method="POST" class="row g-3" >
...
<div class="row">
      ...
      <?php
            ...
            ?>
                ...
                <div class="card margenP" style="width: 25vh; border-radius: 10px;">
                    <div class="tarjeta">
                    <?php echo "<a href='tipoPErfil.php?id=".$fila['id']."' target='_blank'>";?>
                        <div class="archivo" style="background-image: url(<?php echo $imagen ?>);"></div>
                    <?php echo "</a>"; ?>
                        <div class="datosU text-center">
                            <?php echo "<a href='tipoPErfil.php?id=".$fila['id']."' target='_blank'><p class='nombres'>".$fila['nombre']." ".$fila['apellidoPaterno']." ".$fila['apellidoMaterno']."</p></a>" ?> 
            ...
            ?>
                ...
                <!-- NUEVO DIV DE USUARIOS -->
                <div class="card margenP" style="width: 50vh; border-radius: 10px;">
                    <div class="tarjeta">
                    <?php echo "<a href='tipoPErfil.php?id=".$fila['id']."' target='_blank'>";?>
                        <div class="archivo" style="background-image: url(<?php echo $imagen ?>);"></div>
                    <?php echo "</a>"; ?>
                        <div class="datosU text-center">
                            <?php echo "<a href='tipoPErfil.php?id=".$fila['id']."' target='_blank'><p class='nombres'>".$fila['nombre']." ".$fila['apellidoPaterno']." ".$fila['apellidoMaterno']."</p></a>" ?> 
                            <!--<a href="#" class="btn btn-sm btn-success" style="width: 90%;">Correo</a>-->
                            <?php echo "<a href='email.php?id=".$fila['email']."' class='btn btn-sm btn-success' style='width:90%;margin-top:0;'>Correo</a>"?>
                        </div>
