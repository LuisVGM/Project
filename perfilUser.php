...
<div class="btn-group"  style="float: right;margin-top: 1%;margin-right:2px;">
  ...
  <div class="dropdown-menu">
    ...
    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#fotoPortada" id="<?php $_SESSION['id'] ?>">Foto de portada</a>
        ...
        <div class="photo perfil limite" style="background-image: url(<?php echo $imagen ?>)"></div>
        <!-- CAMBIAR FOTO PERFIL 
  ...
  <path d="M8 11a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5zm0 1a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zM3 6.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"/>
        ...
        <div class="photo nameperfil">
          <h2 style=""><?php echo $_SESSION['name'] ." ". $_SESSION['apellidoP'] ." ". $_SESSION['apellidoM']; ?></h2>
        </div>
...
<!--
          ...
          <select name="nivelA" id="especialidad" class="form-control"  required>

            <option value="">...</option>

            <?php

                $nacade="SELECT * FROM nivelacademico";

                $ejecutar= mysqli_query($Conexion,$nacade);

                while ($academicoNa= mysqli_fetch_array($ejecutar)) {

            ?>

                <option value=<?php echo $academicoNa['id'] ?> > <?php echo $academicoNa['descripcion'] ?></option>
          ...
          <select name="cuatrimestre" id="especialidad" class="form-control"  required>

            <option value="">...</option>

            <?php

                $cuat="SELECT * FROM cuatrimestre";

                $ejecutar= mysqli_query($Conexion,$cuat);

                while ($grado= mysqli_fetch_array($ejecutar)) {
          ...
          <select name="grupo" id="especialidad" class="form-control"  required>

            <option value="">...</option>

            <?php

                $tugrupo="SELECT * FROM grupo";

                $ejecutar= mysqli_query($Conexion,$tugrupo);

                while ($salon= mysqli_fetch_array($ejecutar)) {

            ?>

                <option value=<?php echo $salon['id'] ?> > <?php echo $salon['grupo'] ?></option>
      ...
      <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body"> 
            ...
            <textarea class="form-control" name="descripcion" id="descripcion" cols="40" rows="5" placeholder="Redacta tu descripción"><?php echo $trabajo['descripcion'] ?></textarea>
