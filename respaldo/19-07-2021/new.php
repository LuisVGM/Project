...
?>
  ...
  <div class="container">-->
      ...
      <div class="card" style="border: none;">
        ...
        <!--<div class="card-body">-->
          <div class="portada" style="background-image: url(<?php echo $tabla['portada']; ?>); cursor: pointer;";>
            <button class="btn btn-secondary" style="float: right;">Cambiar portada</button>
          </div>
    ...
    <main class="container">
        <div class="border rounded overflow-hidden shadow-sm position-relative row panelInfo">
          <div class="col-md-6">
            <ul class="datos">
              <li>
              ...
              <?php echo "<h6 class='mb-0'>".$_SESSION['usuario']."</h6>" ?></li>
